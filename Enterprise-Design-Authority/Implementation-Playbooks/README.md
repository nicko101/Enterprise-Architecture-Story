...
* **[ClearPass Intune Integration](./ClearPass%20Intune%20Integration/)**: Device-based access control using Intune compliance and certificates.
* **[GPO to Intune Profiles](./GPO%20to%20Intune%20Profiles/)**: Migrating legacy Group Policy to cloud-native endpoint management.
...
* **[Azure Firewall (Hub-and-Spoke Governance)](./Azure%20Firewall%20(Hub-and-Spoke%20Governance)/)**: Centralised security and traffic control for spoke VNets.
* **[Azure Connectivity (Load Balancing)](./Azure%20Connectivity%20(Load%20Balancing)/)**: Azure Load Balancer design and traffic distribution patterns.
* **[Azure Application Gateway (L7 & Host-Based Routing)](./Azure%20Application%20Gateway%20(L7%20&%20Host-Based%20Routing)/)**: Layer 7 ingress control with TLS termination and routing logic.

### Platform & Infrastructure Modernisation
* **[Azure Deployment: Palo Alto Networks NGFW (VM-Series)](./Azure%20Deployment:%20Palo%20Alto%20Networks%20NGFW%20(VM-Series)/)**: Third-party firewall integration in Azure for advanced security enforcement.
* **[Azure Storage (DFS to Files)](./Azure%20Storage%20(DFS%20to%20Files)/)**: Modernising legacy DFS-based file services using Azure Files.
* **[Azure Private Endpoints](./Azure-Private-Endpoints/)**: Removing public exposure of PaaS services through Private Link.
...
Specialising in Hybrid Connectivity, Security, and Azure Architecture
